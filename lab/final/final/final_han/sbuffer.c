...
//#endif 
//#ifndef WAIT_FOR_INSERT
//    #define WAIT_FOR_INSERT 6     //define when buffer is null , how long should it wait for insert before exit
//#endif
...
int sbuffer_remove(sbuffer_t * buffer,sensor_data_t * data)
{
  ...
  b_result = pthread_cond_timedwait(&dbInit,&buf_mutex,&outtime); // wait for new data add to buffer
  }
  if(b_result==ETIMEDOUT)    // if timeout return NO_DATA
      {
