...
extern err_code_t stack_save( const stack_t *, const char *path  ); /* save stack to file */
extern err_code_t stack_restore( stack_t *, const char *path  ); /* load stack from file */
